...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profit', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='api.profit', verbose_name='Информация о продажах товара')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prediction', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='api.prediction', verbose_name='Прогноз')),
